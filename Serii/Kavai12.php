    ...
    <ul class="list-unstyled mt-3 mb-4">
      ...
      <li style="background-color:#F08080;font-family: Palatino linotype;">Закончив младшую школу, Кадзунари Уса надеялся на
       ...
       <div class="player" style="display: block;">
         ...
         <a href="/Serii/Kavai12.php"style="text-decoration:none;color:#000000;background-color:#CD5C5C;font-family: cursive;white-space: nowrap;">12-серия</a>
         <iframe class="main-player" scrolling="no" allowfullscreen=""
         src="https://video.sibnet.ru/shell.php?videoid=1648879" frameborder="0" width="100%" height="360"></iframe>
      </div>
    </div>
