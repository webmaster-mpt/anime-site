...
if (isset($data['do_create']))
{
    ...
    if (empty($errors))
    {
        ...
        $create->desсription = $data['desсription'];
...
<body>
    ...
    <div class="container">
            <form method="post">
                ...
                <input type="text" name="series" value="<?php echo @$data['series'];?>" placeholder="Серии"><br><br>
                ...
                <textarea name="desсription" placeholder="Описание"><?php echo @$data['desсription'];?></textarea><br><br>
                <label>Ссылка на видео</label><br>
                <textarea name="iframe"><?php echo @$data['iframe'];?></textarea><br><br>
