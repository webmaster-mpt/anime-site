...
<div class="container">
  ...
  <div class="d-flex flex-wrap">
    <div class="card mb-4 shadow-sm"style="width:100%;opacity:0.7;color:#000000;background-color:#B22222;font-family: cursive">
      <div class="card-header">
        <h2 class="my-0 font-weight-normal">О сайте fasa_anime</h2>
  ...
  <div class="card mb-4 shadow-sm"style="width:100%;opacity:0.9;color:#000000;background-color:#66CDAA;font-family: cursive">
    <div class="card-header">
      <h2 class="my-0 font-weight-normal">О сайте</h2>
      <h4 class="my-0 font-weight-normal">Данный сайт написан студентом 3-го курса для сдачи лабы.Надеемся на сдачу. Возможно сайт будет развиваться и будет зарегистрирован для общества. </h4>
    </div>
  </div>
</div>
<? require "footer.php"?>
